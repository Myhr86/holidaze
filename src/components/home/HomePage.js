  ...
  return (
    <>
        <Col container className="block" id="search">
          <img className="block__image" src={bgImg} alt="People walking at the docks in Bergen "/>
          <div className="block__elem">
            <h2 className="block__header">
              KOM OG OPPLEV DET FLOTTESTE BERGEN HAR Å BY PÅ! HOS OSS FINNER DU
              DE BESTE OVERNATTINGENE I BERGEN.{" "}
            </h2>
        ...
        <Row xs={1} sm={1} md={3} lg={3} xl={3} xxl={3} className="hikeBlock">
          <Col className="hikeBlock__elem">
            ...
            <img src={walk} className="hikeBlock__image" alt="People waking in Bergen city"/>
          </Col>
          <Col className="hikeBlock__elem">
        ...
        <Row xs={2} sm={1} lg={2} xl={2} xxl={2} className="hotelBlock">
          <Col xs={12} lg={6} xl={6} xxl={6} className="hotelBlock__elem">
            <img className="hotelBlock__image" src={pillow} alt="A pillow on a hotel bed"/>
          </Col>
          <Col xs={12} xl={4} xxl={6} className="hotelBlock__elem">
            <h3 className="hotelBlock__heading">Finn din overnatting</h3>
