    ...
    <Row xs={1} sm={1} md={3} lg={3} xl={3} xxl={3} className="hikeBlock">
      <Col className="hikeBlock__elem">
        ...
        <p className="overLayText">
          Bergen is a beautiful city to walk around in and explore. It has many
          old and majestetic buildings and ornaments for you to take in. Bergen
          is known for the docks by the sea, which are brewing with activity
          much of the year.
        </p>
        <img
          src={walk}
